...
class kitti_object(object):
    ...
    def __init__(self, root_dir, split='training'):
        ...
        self.pred_label_dir = os.path.join(self.split_dir, 'label_2')
    ...
    def get_calibration(self, idx):
        ...
        print("CALIB FILENAME: " + calib_filename)
    ...
    def get_label_predicted_objects(self, idx,location):
        label_filename=os.path.join(location, '%06d.txt' % (idx))
        print("PREDICTED LABEL FILENAME: " + label_filename)
        return utils.read_label(label_filename)
