...
if __name__ == '__main__':
    ...
    print("Van on frames list: ")
    for key in sorted(NFramesVan.keys()):
        print(key, " : ", NFramesVan[key])


    print("Truck on frames list: ")
    for key in sorted(NFramesTruck.keys()):
        print(key, " : ", NFramesTruck[key])

    print("0 occlusion: " + str(count0occlusion))
    print("1 occlusion: " + str(count1occlusion))
    print("2 occlusion: " + str(count2occlusion))
    print("3 occlusion: " + str(count3occlusion))

    print("easy count: " + str(counteasy))
    print("moderate count: " + str(countmoderate))
    print("hard count: " + str(counthard))
    print("no dif count: " + str(countnodif))